...
module.exports = grunt => {
    ...
    const terserWorkers = Number.parseInt(process.env.MOODLE_TERSER_WORKERS, 10);
    const terserOptions = {
        // Do not mangle variables.
        // Makes debugging easier.
        mangle: false,
    };
    if (Number.isInteger(terserWorkers) && terserWorkers > 0) {
        terserOptions.numWorkers = terserWorkers;
    }
    grunt.config.merge({
        rollup: {
            options: {
