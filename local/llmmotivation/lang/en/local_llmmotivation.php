...
$string['pluginname'] = 'LLM Motivation & Emotion System';
...
$string['settings_admin_preview'] = 'Enable Admin & Teacher Testing Mode';
$string['settings_admin_preview_desc'] = 'When enabled, site administrators and teachers can preview and test emotional check-in popups and motivation dialogs without switching to a student account.';
...
$string['encouragement_achievement'] = 'Achievement';
$string['encouragement_recovery'] = 'Recovery';
$string['encouragement_persistence'] = 'Persistence';
...
$string['motivation_research_notice'] = '🔒 Tanggapan emosimu dijaga kerahasiaannya untuk menyesuaikan motivasi belajarmu.';
...
$string['settings_heading'] = 'LLM Motivation Configuration';
$string['settings_apikey'] = 'Gemini API Key';
$string['settings_apikey_desc'] = 'Enter your Google Gemini API key for dynamic adaptive encouragement generation.';
$string['settings_model'] = 'Gemini Model';
$string['settings_model_desc'] = 'The model to use for generation (e.g. gemini-1.5-flash or gemini-2.0-flash).';
