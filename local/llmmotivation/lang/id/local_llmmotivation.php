...
$string['pluginname'] = 'Sistem Motivasi & Emosi LLM';
...
$string['settings_admin_preview'] = 'Aktifkan Mode Uji Coba untuk Admin & Guru';
$string['settings_admin_preview_desc'] = 'Jika diaktifkan, Administrator situs dan Pengajar dapat melihat dan menguji popup kesiapan emosi serta dialog motivasi tanpa perlu beralih ke akun siswa.';
...
$string['encouragement_reinforcement'] = 'Penguatan (Reinforcement)';
$string['encouragement_achievement'] = 'Apresiasi Prestasi (Achievement)';
$string['encouragement_recovery'] = 'Pemulihan & Dorongan (Recovery)';
$string['encouragement_persistence'] = 'Ketekunan (Persistence)';
...
$string['motivation_reflection_label'] = '📝 Catatan Refleksi Pribadi (Opsional)';
$string['motivation_reflection_placeholder'] = 'Tuliskan apa yang sedang kamu rasakan atau target belajarmu hari ini...';
$string['motivation_submit'] = 'Kirim Refleksi';
$string['motivation_feeling_required'] = 'Silakan pilih satu perasaan sebelum mengirim responsmu.';
$string['motivation_research_notice'] = '🔒 Data emosi digunakan secara aman dan rahasia untuk menyesuaikan pesan motivasi belajar pribadimu.';
...
$string['motivation_e1_prompt'] = '🔥 Seberapa termotivasi kamu untuk belajar saat ini?';
$string['motivation_e2_prompt'] = '💡 Seberapa percaya diri kamu dengan materi ini?';
$string['motivation_e3_prompt'] = '🤝 Apakah kamu merasa didukung dan siap untuk berlatih?';
$string['motivation_likert_1'] = '😫 1 - Sangat Rendah';
$string['motivation_likert_2'] = '🙁 2 - Rendah';
$string['motivation_likert_3'] = '😐 3 - Cukup / Netral';
$string['motivation_likert_4'] = '😊 4 - Tinggi';
$string['motivation_likert_5'] = '🤩 5 - Sangat Tinggi';
$string['motivation_feedback_required'] = '⚠️ Mohon pilih penilaian untuk ketiga pertanyaan di atas.';
$string['emotion_checkin_title'] = 'Kesiapan Emosi Belajar';
$string['emotion_checkin_subtitle'] = 'Sebelum memulai pembelajaran dan latihan, sampaikan kesiapan emosimu hari ini.';
...
$string['settings_heading'] = 'Konfigurasi Motivasi LLM';
$string['settings_apikey'] = 'Gemini API Key';
$string['settings_apikey_desc'] = 'Masukkan kunci API Google Gemini Anda untuk membangkitkan pesan motivasi adaptif otomatis.';
$string['settings_model'] = 'Model Gemini';
$string['settings_model_desc'] = 'Model yang digunakan untuk pembuatan motivasi (misal gemini-1.5-flash atau gemini-2.0-flash).';
