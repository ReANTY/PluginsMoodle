...
namespace local_llmmotivation\output;
...
class learner_profile_table extends \table_sql {
    ...
    public function __construct(
        ...
        $this->define_headers([
            get_string('fullname'),
            get_string('performancecategory', 'local_llmmotivation'),
            get_string('cognitivelevel',      'local_llmmotivation'),
            get_string('motivationlevel',     'local_llmmotivation'),
            get_string('learningstyle',       'local_llmmotivation'),
            get_string('behavioralscore',     'local_llmmotivation'),
            get_string('engagementscore',     'local_llmmotivation'),
            get_string('lastupdated',         'local_llmmotivation'),
            get_string('actions',             'local_llmmotivation'),
        ]);
    ...
    public function col_actions(\stdClass $row): string {
        ...
        return \html_writer::link(
            $detailurl,
            get_string('viewdetail', 'local_llmmotivation'),
    ...
    protected function get_level_label_class(int $level): array {
        switch ($level) {
            case 1:
                return [get_string('low',    'local_llmmotivation'), 'danger'];
            case 2:
                return [get_string('middle', 'local_llmmotivation'), 'warning'];
            case 3:
                return [get_string('high',   'local_llmmotivation'), 'success'];
            default:
                return ['—', 'secondary'];
        }
    }
