...
/**
 * Custom admin setting class with inline validation for local_llmmotivation.
 *
...
class admin_setting_with_validation extends \admin_setting_configtext {
     ...
     * Constructor.
     *
     * @param string   $name           Unique setting name (e.g. 'local_llmmotivation/weight_attendance').
