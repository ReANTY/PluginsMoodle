...
namespace local_llmmotivation\leaderboard;
...
class leaderboard {
    ...
    public function __construct() {
        ...
        $privacy = get_config('local_llmmotivation', 'leaderboard_privacy');
    ...
    public function trigger_achievement_prompt(int $userid, int $courseid): void {
        ...
        $motivation_class = '\local_llmmotivation\motivation\motivation_component';
    ...
    private function read_weight(string $name, float $default): float {
        $raw = get_config('local_llmmotivation', $name);
