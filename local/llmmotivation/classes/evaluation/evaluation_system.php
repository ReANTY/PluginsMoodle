...
namespace local_llmmotivation\evaluation;
...
class evaluation_system {
    ...
    public function __construct() {
        $configured = get_config('local_llmmotivation', 'performance_decline_threshold');
    ...
    public function send_alert_to_coach(int $userid, int $courseid, array $metrics): void {
        ...
        if (class_exists('\local_llmmotivation\coach\coach')) {
            try {
                \local_llmmotivation\coach\coach::receive_performance_alert(
                    $userid,
                    $courseid,
                    $metrics
                );
