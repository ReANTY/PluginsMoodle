...
$PAGE->set_url(new moodle_url('/local/llmmotivation/config_audit_log.php'));
$PAGE->set_title(get_string('audit_log_title', 'local_llmmotivation'));
$PAGE->set_heading(get_string('audit_log_title', 'local_llmmotivation'));
...
$PAGE->navbar->add(
    get_string('analytics_dashboard', 'local_llmmotivation'),
    new moodle_url('/local/llmmotivation/analytics_dashboard.php')
);
$PAGE->navbar->add(get_string('audit_log_title', 'local_llmmotivation'));
...
echo $OUTPUT->heading(get_string('audit_log_title', 'local_llmmotivation'), 2);
...
$base_url = new moodle_url('/local/llmmotivation/config_audit_log.php', $filters);
