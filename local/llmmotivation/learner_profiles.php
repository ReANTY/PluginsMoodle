...
use local_llmmotivation\output\learner_profile_table;
...
$baseurl = new moodle_url('/local/llmmotivation/learner_profiles.php', [
    'courseid'           => $courseid,
...
$PAGE->set_title(get_string('learnerprofilemonitoring', 'local_llmmotivation'));
...
$filter_options = [
    0 => get_string('allcategories',  'local_llmmotivation'),
    1 => get_string('low',            'local_llmmotivation'),
    2 => get_string('middle',         'local_llmmotivation'),
    3 => get_string('high',           'local_llmmotivation'),
];
...
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('learnerprofilemonitoring', 'local_llmmotivation'));

// --- Filter form ---
$filter_url = new moodle_url('/local/llmmotivation/learner_profiles.php', [
    'courseid' => $courseid,
]);
...
echo html_writer::tag('label',
    get_string('filterbyperformance', 'local_llmmotivation') . ':',
