...
def create_document():
    ...
    aspek_sections = [
        ("1. Aspek Pendahuluan dan Persiapan Sistem\n(Kejelasan instruksi awal, kesiapan aktivitas oleh guru, dan ruang kerja)", [
            ...
            "Template HTML/CSS bersifat read-only dan dapat disembunyikan via tombol, sehingga siswa tidak bingung area edit.",
        ...
        ("2. Aspek Fungsionalitas dan Antarmuka Editor\n(Kemampuan mengetik koding, kejelasan tata letak, dan kontrol interaksi)", [
            ...
            "Tombol Jalankan berfungsi andal mengirim kode ke backend (mod_aicode_run_code) dan memproses test case.",
            ...
            "Antarmuka responsif dan tetap dapat digunakan pada layar yang lebih kecil secara proporsional.",
            "Mekanisme keamanan (prefilter klien + pemeriksaan server security_checker) tidak mengganggu latihan JavaScript yang sah.",
            "Pada mode Ujian, tombol Bantuan (AI Hint) otomatis disembunyikan dan tombol Kirim menjadi penyerahan jawaban akhir."
        ...
        ("3. Aspek Evaluasi dan Kecerdasan Umpan Balik LLM\n(Kualitas analisis kode, prompt engineering, anti-spoiler, dan latency)", [
            "Umpan balik LLM dihasilkan dalam Bahasa Indonesia yang kontekstual dan mudah dipahami siswa SMK.",
            ...
            "Mekanisme caching dan batas panggilan harian (max_calls_per_day) efektif mencegah penyalahgunaan kuota API.",
        ...
        ("4. Aspek Penutup dan Output Sistem\n(Penyimpanan database, gradebook, activity logs, dan reports)", [
            "Sistem menyimpan percobaan siswa (attempts) ke database dengan aman dan terstruktur (aicode_attempts).",
            "Aktivitas penggunaan bantuan AI terekam secara detail (ai_requested_at) untuk menganalisis dependensi siswa.",
            "Hasil analisis umpan balik AI berhasil disimpan (ai_feedback_json) dan dapat ditinjau ulang pada report.php.",
    ...
    for title, items, subtotal_label in aspek_sections:
        ...
        sub_cells[1].text = sub_cells[1].text + subtotal_label
    ...
    doc.add_paragraph("\nSkor Rata-rata Akhir yang Diperoleh: ............................").paragraphs[0].runs[0].bold = True
    doc.add_paragraph("Kesimpulan Kategori Kelayakan: ........................................................").paragraphs[0].runs[0].bold = True
