...
$string['setting_threshold_heading'] = 'Ambang Batas Tingkat Kognitif (Adaptive Learning Path)';
$string['setting_threshold_heading_desc'] = 'Konfigurasi batas nilai evaluasi kognitif yang digunakan untuk menentukan jalur belajar mingguan siswa (Primary, Intermediate, Expert).';
$string['setting_primary_threshold'] = 'Batas Primary (%)';
$string['setting_primary_threshold_desc'] = 'Nilai di bawah persentase ini akan dikelompokkan ke tingkat Primary (fondasi dasar). Default: 70.';
$string['setting_expert_threshold'] = 'Batas Expert (%)';
$string['setting_expert_threshold_desc'] = 'Nilai sama dengan atau di atas persentase ini akan dikelompokkan ke tingkat Expert (mahir). Default: 85. Nilai di antaranya masuk ke Intermediate.';
